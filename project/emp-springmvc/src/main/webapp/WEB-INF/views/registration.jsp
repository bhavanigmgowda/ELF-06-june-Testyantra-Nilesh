        ...
        <form  action="./registration" method="post"  class="col-md-10 offset-1" style="background-color : rgb(236, 236, 114)">
            ...
            <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input name="account_number" type="text" class="form-control"  placeholder="Please EnterAccount Numberr ">
                  </div>
            ...
            <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                        ...
                        <input name="otherInfo.mother_nm" type="text" class="form-control" id="inputAddress" placeholder="Please Enter Mother Name">
                      </div>
                </div>
                ...
                <div class="form-row">
                      ...
                      <div class="form-row">
                        <div  class="form-group col-md-4">
                            ...
                            <select style=""  name="otherInfo.nationality"  width: 408.75px;height: 37.99px;" >
                                <option value="" disabled="disabled" selected="selected">Please select</option>
                            ...
                            <div class="form-group col-md-4">
                                  ...
                                  <input name="otherInfo.passport" type="number" class="form-control" id="inputAddress" placeholder="please enter Passport Number">
                                </div>
                          ...
                          <div class="form-row">
                              ...
                              <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                      ...
                                      <input name="otherInfo.father_nm" type="text" class="form-control"  placeholder="Please Enter Father Name ">
