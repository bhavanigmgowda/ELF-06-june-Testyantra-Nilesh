...
<body>
	<form action="./saveData" method="post" class="col-md-10 offset-1"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputEmail4">ID</label> <input name="id" type="text"
					class="form-control" placeholder="Please Enter ID">
			</div>
			<div class="form-group col-md-6">
				<label for="inputPassword4">Account Number</label> <input
					name="account_no" type="text" class="form-control"
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				<label for="inputPassword4">Email Id</label> <input name="email"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputEmail4">Age</label><br> <input name="age"
					type="text" class="form-control" placeholder="Please Enter Age">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label name="gender" for="inputEmail4">Gender</label><br> <select
			...
			<div class="form-group col-md-6">
				<label for="inputPassword4">Date Of Birth</label> <input name="dob"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputEmail4">Salary</label> <input name="salary"
					type="text" class="form-control"
					placeholder="Please EnterDesignation">
			</div>
			<div class="form-group col-md-6">
				<label for="inputPassword4">Department ID</label> <input type="text"
					name="dept_ID" class="form-control"
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				<label for="inputPassword4">Manager ID</label> <input
					name="manager_ID" type="text" class="form-control"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputPassword4">Date Of Joining</label> <input
					name="joining_date" type="date" class="form-control"
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4">
				<label for="inputPassword4">Emergency Contact Name</label> <input
					name="otherInfo.emergency_contact_name" type="text"
					class="form-control"
					placeholder="Please Enter Emergency Contact Number ">
			</div>
			<div class="form-group col-md-4">
				<label for="inputAddress">Mother Name</label> <input
					name="otherInfo.mother_name" type="text" class="form-control"
					id="inputAddress" placeholder="Please Enter Mother Name">
			</div>
		</div>

		<div class="form-row">
			<div class="form-group col-md-4">
				<label for="inputEmail4">Pan Number</label> <input
					name="otherInfo.pan" type="text" class="form-control"
					placeholder="Please Enter Pan Number">
			</div>
			<div class="form-group col-md-4">
				<label for="inputPassword4">Emergency Contact Number</label> <input
					name="otherInfo.emergency_contact_number" type="text"
					class="form-control"
					placeholder="Please Enter Emergency Contact Number ">
			</div>
			<div class="form-group col-md-4">
				<label for="inputAddress">Spouse Name</label> <input
					name="otherInfo.spouse_NM" type="text" class="form-control"
					id="inputAddress" placeholder="Please Enter Spouse Name">
			</div>
		</div>
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4">
				...
				<label for="inputPassword4">Nationality</label> <select style=""
					name="otherInfo.nationality"width: 408.75px;height: 37.99px;" >
					<option value="" disabled="disabled" selected="selected">Please
						select</option>
			...
			<div class="form-group col-md-4">
				<label for="inputAddress">Passport Number</label> <input
					name="otherInfo.passport" type="number" class="form-control"
					id="inputAddress" placeholder="please enter Passport Number">
			</div>
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4">
				<label for="inputPassword4">Religion</label> <select
					name="otherInfo.religion" style="width: 408.75px; height: 37.99px;">
					<option value="" disabled="disabled" selected="selected">Please
						select</option>
			...
			<div class="form-group col-md-4">
				<label for="inputAddress">Aadhar Number</label> <input
					name="otherInfo.adhar" type="text" class="form-control"
					id="inputAddress" placeholder="Please Enter  Aadhar Number">
			</div>
		</div>
		...
		<div class="form-row">
			...
			<div class="form-group col-md-4">
				<label for="inputPassword4">Father Name</label> <input
					name="otherInfo.father_name" type="text" class="form-control"
